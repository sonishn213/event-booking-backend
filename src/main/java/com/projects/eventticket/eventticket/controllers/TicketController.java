...
import com.projects.eventticket.eventticket.mappers.TicketMapper;
...
public class TicketController {
    ...
    public Page<ListTicketResponseDto> listTickets(
        ...
        return ticketService
                .listTicketsForUser(parsUserId(jwt), pageable)
    ...
    public ResponseEntity<GetTicketResponseDto> getTicket(
       ...
       return ticketService.getTicketForUser(parsUserId(jwt),ticketId)
    ...
    public ResponseEntity<byte[]> getTicketQrCode(
        ...
        byte[] qrCodeImage = qrCodeService.getQrCodeImageForUserAndTicket(parsUserId(jwt),ticketId);
